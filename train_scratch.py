...
def main():
    ...
    matrix = confusion_matrix(predicted, splits["y_test"])
    ...
    if not args.no_plots:
        ...
        sample_errors(
            splits["x_test"], splits["y_test"], predicted, path=OUT_DIR / "fig_errors_scratch.png"
        )
        weight_grid(model.weight_matrices()[0], path=OUT_DIR / "fig_weights_scratch.png")
